...
# Example usage
file_path = 'Forming Voltage-S11.csv'  # Path to your CSV file
column_name = 'Corresponding Data Point'  # Column name to plot
num_bins = 100  # Number of bins
output_file = 'S11-Forming Voltage-histogram.jpg'  # Output file name
x_limits = (0, 10)  # Define your x-limits here, e.g., (min_x, max_x)
