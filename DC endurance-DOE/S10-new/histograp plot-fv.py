...
# Example usage
file_path = 'Forming Voltage-S10.csv'  # Path to your CSV file
column_name = 'Corresponding Data Point'  # Column name to plot
num_bins = 100  # Number of bins
output_file = 'S10-Forming Voltage-recent histogram.jpg'  # Output file name
x_limits = (0, 10.2)  # Define your x-limits here, e.g., (min_x, max_x)
