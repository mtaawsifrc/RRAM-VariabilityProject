...
hrs3 = pd.read_csv('S3-Hrs.csv')
lrs3 = pd.read_csv('S3-Lrs.csv')
...
ax.plot(hrs2['Data Points'], hrs2['CDF'], 'ok', label='Oxygen Poor', color='blue', lw=0.5, markersize=1.5)
ax.plot(lrs2['Data Points'], lrs2['CDF'], 's', label='Oxygen Poor', color='blue', lw=0.5, markersize=2)

ax.plot(hrs3['Data Points'], hrs3['CDF'], 'ok', label='Oxygen Rich', color='red', lw=0.5, markersize=1.5)
ax.plot(lrs3['Data Points'], lrs3['CDF'], 's',label='Oxygen Rich', color='red', lw=0.5, markersize=2)
...
legend = plt.legend(fontsize=8,ncol=1 ,bbox_to_anchor=(1, 0.7))
legend.get_frame().set_visible(False)



plt.text(1e-4, -0.03, "LRS Currents", fontsize=10, ha='center', va='center')
plt.text(1e-6, -0.03, "HRS Currents", fontsize=10, ha='center', va='center')
plt.text(2e-5, 0.5, "Vread: 0.1V", fontsize=10, ha='center', va='center')
...
plt.savefig('CDF 22323.jpeg', dpi=1200, facecolor='w', edgecolor='w', transparent=False,
